...
// Copied from https://github.com/jonahwilliams/flutter_shaders/blob/main/lib/src/animated_sampler.dart
...
/// A callback for the [SnapshotSampler] widget.
typedef SnapshotSamplerBuilder = void Function(
  ui.Image image,
  Size size,
  ui.Canvas canvas,
);
...
class SnapshotSampler extends SingleChildRenderObjectWidget {
  const SnapshotSampler(
    this.builder, {
    super.key,
    super.child,
    this.enabled = true,
  ...
  final SnapshotSamplerBuilder builder;
  final bool enabled;
...
class _RenderShaderSamplerBuilderWidget extends RenderProxyBox {
  ...
  _RenderShaderSamplerBuilderWidget({
    ...
    required SnapshotSamplerBuilder builder,
  ...
  SnapshotSamplerBuilder get builder => _builder;
  SnapshotSamplerBuilder _builder;
  set builder(SnapshotSamplerBuilder value) {
    if (value == builder) {
      return;
    }
    _builder = value;
...
/// A [Layer] that uses an [SnapshotSamplerBuilder] to create a [ui.Picture]
...
class _ShaderSamplerBuilderLayer extends OffsetLayer {
  ...
  SnapshotSamplerBuilder get callback => _callback;
  SnapshotSamplerBuilder _callback;
  set callback(SnapshotSamplerBuilder value) {
    if (value == callback) {
      return;
    }
    _callback = value;
