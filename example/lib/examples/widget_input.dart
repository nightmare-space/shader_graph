...
class WidgetInputExample extends StatefulWidget {
  const WidgetInputExample({super.key});

  @override
  State<WidgetInputExample> createState() => _WidgetInputExampleState();
}

class _WidgetInputExampleState extends State<WidgetInputExample> {
  int currentIndex = 0;
  @override
